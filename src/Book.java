...
public class Book {
    ...
    public boolean equals(Object o) {
        ...
        Book book = (Book) o;
        return datePublication == book.datePublication && Objects.equals(name, book.name) && Objects.equals(author, book.author);
    }

    @Override
    public int hashCode() {
        return Objects.hash(name, datePublication, author);
    }
}
